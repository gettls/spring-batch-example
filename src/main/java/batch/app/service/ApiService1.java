...
public class ApiService1 extends AbstractApiService{
	...
	protected ApiResponseVO doApiService(RestTemplate restTemplate, ApiInfo apiInfo) {
		...
		ResponseEntity<String> responseEntity = restTemplate.postForEntity("http://localhost:8081/api/product/1", apiInfo, String.class);		int statusCodeValue = responseEntity.getStatusCodeValue();
